...
import com.tools.formatter.util.XMLStringFormatter;
...
public class XMLFormatter {
	...
	public FormatterResponse format(@Context HttpServletResponse response, @QueryParam("input") String str,
			FormatterRequest req) {
		String decodedValue = "";
		...
		try {
			if (str == null)
				str = req.getInput();
			decodedValue = XMLStringFormatter.formatXMLString(str);
